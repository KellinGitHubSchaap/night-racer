...
//
//
public class SetRPMToSlider : MonoBehaviour { // this script was only made for slider demo scene for demonstration purposes only
    ...
    private void Start()
    {
        ...
        res.carCurrentSpeed = (int)rpmSlider.value;
        res.carMaxSpeed = res.maxRPMLimit;
    }
