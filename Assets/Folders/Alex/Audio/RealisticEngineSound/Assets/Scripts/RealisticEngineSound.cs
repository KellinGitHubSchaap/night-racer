...
public class RealisticEngineSound : MonoBehaviour {
    ...
    // editor bools
    [HideInInspector]
    public bool editClips = false;
    [HideInInspector]
    public bool editCurves = false;
    [HideInInspector]
    public bool editSettings = false;
    [HideInInspector]
    public bool showLimiter = false;
    [HideInInspector]
    public bool showReverse = false;
    [HideInInspector]
    public bool showCurvesGrid = true;
    [HideInInspector]
    public bool showPitchCurves = false;
    [HideInInspector]
    public bool showPitchOnCurves = false;
    [HideInInspector]
    public bool hideVolumeCurves = false;
    [HideInInspector]
    public bool debugInfo = false;
    // curves in global
    [HideInInspector]
    public bool showCurrentRpm = true;
    [HideInInspector]
    public bool showIdleRpm = true;
    [HideInInspector]
    public bool showLowRpm = true;
    [HideInInspector]
    public bool showMediumRpm = true;
    [HideInInspector]
    public bool showHighRpm = true;
